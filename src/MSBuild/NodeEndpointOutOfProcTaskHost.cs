...
namespace Microsoft.Build.CommandLine
{
    ...
    internal class NodeEndpointOutOfProcTaskHost : NodeEndpointOutOfProcBase
    {
        ...
        {
            return CommunicationsUtilities.GetHostHandshake(HandshakeOption.From(taskHost: true));
        }
        ...
        {
            return CommunicationsUtilities.GetClientHandshake(HandshakeOption.From(taskHost: true));
        }
    }
}
